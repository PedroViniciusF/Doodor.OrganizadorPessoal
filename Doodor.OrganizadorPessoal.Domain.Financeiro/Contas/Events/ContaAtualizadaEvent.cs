...
{
    public class ContaAtualizadaEvent : Event
    {
        public ContaAtualizadaEvent(Guid id, string nome, double valorTotal, bool pago, int qtdParcelas, DateTime dataPgto, bool parcelado, DateTime diaPrimeiroPgto, int frequenciaDiaPgto, int porcVariacaoMensal)
        {
            Id = id;
            Nome = nome;
